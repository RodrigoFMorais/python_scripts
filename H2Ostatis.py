...
#truncated_octahedron(ListaNei[i],CSurf[i],AtomListC[i],CM[i],dPtPt)
    ...
    for i in range(0,len(coordN)):
		    ...
		    if CSurf[i]==4 or CSurf[coordN[i][j]]==4 or CSurf[coordN[i][j]]==4 or (CSurf[i]==5 and CSurf[coordN[i][j]]==5 or CSurf[coordN[i][j]]==5):  
                        if dist<=4.5:
                                temp=[]
...
dPtPt=3.3 #Pt-Pt maximum distance in A.
dPtO=2.4 #Pt-O maximum distance in A.
...
## Calculate the radial distribution of water for t=0.
...
for li in range(0,1):
                ...
                for i in range(0,len(AtomOCoordC)):
                        dist=CalcDist(CM,AtomOCoordC[i])
                        DT.append(dist)
                ...
                for j in range(0,100):
                        ...
                        for i in range(0,len(AtomOCoordC)):
                                ...
                                if j==0 :
                                        ...
                                        if DT[i] >= j*(14.5/100) and DT[i] < (j+1)*(14.5/100):
                                                temp1 = temp1 + 1
                        tempMat1.append(temp1)

                for i in range(0,100):
                        print i*(14.5/100), tempMat1[i]

## Calcualte the radial distribution of water for t=end.

AtomPt=0
AtomO=0
AtomH=0

file=open("XDATCAR_run" + str(type),"r")
linhas=[]
linhas=file.readlines()
file.close()
